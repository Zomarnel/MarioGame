    ...
    public static class Boundaries
    {
        ...
        public static void VerticalBoundariesCheck(Player player)
        {
            ...
            foreach (Boundary bnd in _boundaries)
            {
                ...
                {
                    if (bnd.IsPointInsideBoundary(xCoordinate, yCoordinate + 32) || bnd.IsPointInsideBoundary(xCoordinate + 32, yCoordinate + 32))
                    {
                ...
                {
                    if (bnd.IsPointInsideBoundary(xCoordinate, yCoordinate) || bnd.IsPointInsideBoundary(xCoordinate + 32, yCoordinate))
                    {
