namespace Core
{
    public static class GameInfo
    {
        ...
        public static readonly double GAME_GRAVITY = 0.234; //0.125

        public static readonly double PLAYER_HORIZONTAL_MIN_SPEED = 0.5;

        public static readonly double PLAYER_HORIZONTAL_MAX_SPEED = 5;
        ...
        public static readonly double PLAYER_VERTICAL_SPEED = Math.Sqrt(60); //5.5 // sqrt(32)
